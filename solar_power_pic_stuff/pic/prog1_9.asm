...
; ===================================================================== main ==
	...
	constant LED_PORT=PORTD
	constant LED_RED_GREEN=0
	constant LED_RED_BIT=1
...
led_off
	BANKSEL LED_PORT ; BANK0
	BCF LED_PORT, LED_RED_GREEN
	BCF LED_PORT, LED_RED_BIT
	RETURN

led_red
	BANKSEL LED_PORT ; BANK0
	BCF LED_PORT, LED_RED_GREEN
	BSF LED_PORT, LED_RED_BIT
	RETURN

led_green
	BANKSEL LED_PORT ; BANK0
	BSF LED_PORT, LED_RED_GREEN
	BCF LED_PORT, LED_RED_BIT
	RETURN
