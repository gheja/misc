...
measure_an4
	...
	SETF ADCON0, b'10100001' ; FOSC/2, AN4, !GO, ADON
...
loop1
	...
	CALL led_green
	WFI_MACRO 0x02             ; 0.50 seconds passed in total
	GOTO loop1
...
main_loop
	...
	WFI_MACRO 0x01             ; 7.75 seconds passed in total
	...
	CALL led_off
	WFI_MACRO 0x02             ; 9.50 seconds passed in total

	CALL show_charge_led_0
	WFI_MACRO 0x02             ; 10.00 seconds passed in total

	CALL measure_an4
	WFI_MACRO 0x02             ; 10.50 seconds passed in total

	CALL do_temperature_check
	WFI_MACRO 0x02             ; 11.00 seconds passed in total

	CALL eth_send_packet
	WFI_MACRO 0x04             ; 12.00 seconds passed in total

	CALL panic_check
	WFI_MACRO 0x0C             ; 15.00 seconds passed in total
